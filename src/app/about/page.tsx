      ...
      <section className="py-16 md:py-24 bg-gradient-to-br from-indigo-600 to-purple-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-lg md:text-xl max-w-2xl mx-auto">
            Explorer l’univers de la technologie, c’est comprendre le monde
            d’aujourd’hui et bâtir celui de demain.
          </p>
        </div>
      </section>
        ...
        <div className="container mx-auto px-4 grid md:grid-cols-2 gap-12 items-center">
          <div>
            ...
            <p className="text-gray-600 dark:text-gray-300 mb-4">
              La technologie n’est pas seulement une question de machines ou de
              code. C’est un levier puissant pour améliorer la vie humaine,
              connecter les esprits, et repousser les limites du possible.
            </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="mt-4 text-gray-600 dark:text-gray-300">
              Des principes qui guident notre mission dans l’univers digital.
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md">
              ...
              <p className="text-gray-600 dark:text-gray-300">
                Viser la qualité, l’exactitude et la pertinence dans tout ce que
                nous partageons.
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-lg p-6 shadow-md">
